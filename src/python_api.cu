...
PYBIND11_MODULE(pyngp, m) {
	...
	py::enum_<ENerfActivation>(m, "NerfActivation")
		...
		.value("Exponential10x", ENerfActivation::Exponential10x)
		.export_values();
	...
	testbed
		...
		.def_readwrite("add_sdf_free_space_loss_tracking", &Testbed::m_add_sdf_free_space_loss_tracking)
		...
		.def_readwrite("use_coslam_sdf_in_nerf", &Testbed::m_use_coslam_sdf_in_nerf)
		...
		.def_readwrite("max_num_steps_per_ray", &Testbed::m_nerf_steps)
		//DEBUG
		//DEBUG
	...
	training
		...
		.def_readwrite("volsdf_beta", &Testbed::Nerf::Training::volsdf_beta)
		.def_readwrite("sdf_supervision_lambda", &Testbed::Nerf::Training::sdf_supervision_lambda)
		.def_readwrite("sdf_supervision_lambda_tracking", &Testbed::Nerf::Training::sdf_supervision_lambda_tracking)
		.def_readwrite("sdf_free_space_supervision_lambda", &Testbed::Nerf::Training::sdf_free_space_supervision_lambda)
		.def_readwrite("sdf_free_space_supervision_lambda_tracking", &Testbed::Nerf::Training::sdf_free_space_supervision_lambda_tracking)
